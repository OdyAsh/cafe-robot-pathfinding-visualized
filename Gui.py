...
class Gui:
    ...
    def ui():
        # left_frame == Left column of application that contains buttons for the maze type, chosen algorithm, and instructions
        ...
        Button(globals.left_frame, text='Save preset', command=MazeGeneration.save_preset, font = ("Helvetica", 10),
            bg='white').grid(row=2, column=0, padx=5, pady=(10, 20))
        Button(globals.left_frame, text='Build maze', command=partial(MazeGeneration.build_maze, globals.grid), font = ("Helvetica", 14),
        ...
        Button(globals.left_frame, text='Reset', command=MazeGeneration.Reset, font = ("Helvetica", 14),
